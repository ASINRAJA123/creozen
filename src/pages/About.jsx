...
export default function About() {
  ...
  return (
    <motion.section
      className="relative pt-20 md:pt-28 pb-16 md:pb-24 bg-background text-gray-100 min-h-screen overflow-x-hidden"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2. Who We Are & Globe */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16 lg:-mt-16">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {philosophyItems.map((item, idx) => (
              <motion.div key={idx} className="bg-background/50 p-6 rounded-lg border border-gray-800 hover:border-accent hover:-translate-y-1 transition-all duration-300 group backdrop-blur-sm"
