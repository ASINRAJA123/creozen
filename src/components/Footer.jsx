      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            <h3 className="text-2xl font-bold text-white mb-4 font-sans">Creozen</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-400 hover:text-accent hover:underline transition-all text-sm font-sans">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-accent hover:underline transition-all text-sm font-sans">
                  About
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-400 hover:text-accent hover:underline transition-all text-sm font-sans">
                  Services & Products
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-accent hover:underline transition-all text-sm font-sans">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm font-sans">
              ...
              <li className="text-gray-400">
                IN: <a href="tel:+916381738184" className="hover:text-accent transition-colors">+91 6381738184</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-gray-500 md:order-1 font-sans">&copy; {new Date().getFullYear()} Creozen. All rights reserved.</p>
